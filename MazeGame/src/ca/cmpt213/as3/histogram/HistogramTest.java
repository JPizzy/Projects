...
public class HistogramTest extends TestCase {
	...
	public void testSetData() {
		Histogram hist;
		hist = new Histogram(new int [] {}, 4);
		assertBarCountEqual(hist.iterator(), new int[]{0, 0, 0, 0});
		assertBarsRange(hist.iterator(), 1);
		
		hist.setData(new int [] {0, 10, 20, 30, 40, 50});
		assertBarCountEqual(hist.iterator(), new int[]{2, 1, 1, 2});
		assertBarsRange(hist.iterator(), 13);
	}
	
	public void testNegativeNumbers() {
		Histogram hist;
		hist = new Histogram(new int [] {}, 1);
		hist.setData(new int [] {-1, -4});
		assertBarCountEqual(hist.iterator(), new int[]{0});
		assertBarsRange(hist.iterator(), 1);
	}
	
	public void testSetBarSize() {
		Histogram hist;
		hist = new Histogram(new int [] {0, 1, 2, 3, 4}, 1);
		assertBarCountEqual(hist.iterator(), new int[]{5});
		assertBarsRange(hist.iterator(), 5);
		
		hist.setNumberBars(5);
		assertBarCountEqual(hist.iterator(), new int[]{1, 1, 1, 1, 1});
		assertBarsRange(hist.iterator(), 1);
	}
	...
	public void testDataImmutability() {
		Histogram hist;
		int data [] = {0, 1, 2, 3};
		hist = new Histogram(data, 4);
		assertBarCountEqual(hist.iterator(), new int[]{1, 1, 1, 1});
		assertBarsRange(hist.iterator(), 1);
	...
	public void testHighestBar() {
		Histogram hist;
		hist = new Histogram(new int [] {1, 1, 1, 1, 2, 2, 3}, 1);
		assertEquals(hist.getMaxBarCount(), 7);
		
		hist = new Histogram(new int [] {1, 1, 1, 1, 2, 2, 3}, 3);
		assertEquals(hist.getMaxBarCount(), 4);
	}
